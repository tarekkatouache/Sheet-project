...
// CORS setup - do this once, and before routes
app.use(
  cors({
...
const technicalSheetsRoutes = require("./routes/technicalSheets");
...
app.use("/api/systems", systemsRoutes);
app.use("/api/instruments", instrumentsRoutes);
app.use("/api/technicalSheets", technicalSheetsRoutes); // Only once
