...
router.post(
  ...
  async (req, res) => {
    ...
    try {
     ...
     // In backend/routes/subSystems.js around line 180
try {
  const newSubSystem = await SubSystem.create({
    ...
    original_path_file: originalPath,
    pdf_path_file: pdfPath
  });
