...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      if (!req.body.systemId || !req.body.name || !req.body.code) {
        return res.status(400).json({
          message: "Missing required fields: systemId, name, or code",
        });
      }
...
router.get("/by-system/:systemId", authenticateToken, async (req, res) => {
  try {
