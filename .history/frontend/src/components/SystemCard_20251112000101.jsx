...
function SystemCard({ system, onDelete, onEdit }) {
  ...
  function handleDisplaySheetSystem(system) {
    console.log("Opening PDF at path:", system.pdf_path_file);
    window.open(`http://localhost:5000/${system.pdf_path_file}`, "_blank");
  }
