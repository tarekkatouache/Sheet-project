...
export default function TechnicalPage() {
  ...
  useEffect(() => {
    ...
    // Search filter in system description || instrument description || instrument Location ||
    if (search) {
    ...
    //       (s.instrument &&
    //         s.instrument.description &&
    //         s.instrument.description.toLowerCase().includes(lowerSearch)) ||
    //       (s.instrument &&
    //         s.instrument.location &&
    //         s.instrument.location.toLowerCase().includes(lowerSearch))
    //   );
    // }
