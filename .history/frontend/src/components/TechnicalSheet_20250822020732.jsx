...
import { getInstrumentById } from "../services/instruments";
import { getSystemById } from "../services/systems";
...
function TechnicalSheet({ sheet, onDelete }) {
  // get each instrument and system details by their IDs
  const [instrument, setInstrument] = useState(sheet.Instrument || {});
  // const [system, setSystem] = useState(sheet.System || {});
  console.log("Instrument:", instrument);
  getInstrumentById(sheet.instrumentId).then(setInstrument);
  // console.log("System:", system);
  // getSystemById(sheet.systemId).then(setSystem);
  console.log("Instrument:", instrument);
      ...
      <div className="technical-sheet-card">
        <div className="technical-sheet">
          <div className="inside-technical-sheet">
            ...
            <p>user id: {sheet.uploadedByUserId}</p>
            <h3>{sheet.id}</h3>
