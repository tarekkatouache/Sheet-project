...
// get instruments by subSystemId
export const getInstrumentsBySubSystemId = async (subSystemId) => {
  const response = await api.get(`/instruments/by-subsystem/${subSystemId}`);
  return response.data;
};
